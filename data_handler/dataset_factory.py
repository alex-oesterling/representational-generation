...
dataset_dict = {
    "stable_bias_i": ["data_handler.stable_bias", "StableBiasIdentity"],
    ...
    "finetune": ["data_handler.finetune", "Finetune"],
}
...
class GenericDataset(data.Dataset):
    def __init__(self, args, split):
        self.args = args
        self.split = split
        self.root = f"/n/home07/iislasluz/representational-generation/datasets"
